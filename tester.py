...
#opening json file
with open("PMC-1064895-17-Results.json") as jsonfile:
	print jsonfile
...
print len(geniarelevant)
for a in geniarelevant:
	print a
...
print len(metarelevant)
for b in metarelevant:
	print b
...
print totalfound, totaldenotations, totalfound/totaldenotations
...
print "Precision: " + str(float(totalfound)/totaldenotations) 
"""
...
stats.write("precision: " + str(float(totalfound)/totaldenotations) + "\n\n")
